...
function TaskForm2stateMulti_useState(props) {
    ...
    const [uiTechErr, setUiTechErr] = useState()
    const [backEndTechErr, setBackEndTechErr] = useState()
    ...
    const formValidation = (task, nameForm) => {
        switch (nameForm) {
            ...
            case "backEndTech":
                ...
                setBackEndTechErr(backEndTechErr)
                break
...
export default TaskForm2stateMulti_useState
